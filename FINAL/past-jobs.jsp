...
<head>
    ...
    <title>Past Jobs | JetBlue Transport</title>
    <link rel="stylesheet" href="css/past-jobs.css">
...
<body>
    ...
    <a href="past-jobs.jsp" class="nav-button active">
...
<!-- new -->
            ...
            <div class="content-wrapper">
                <div class="jobs-list" id="jobsList">
                    ...
                    try {
                        ...
                        // Prepare SQL query to fetch past jobs
                        ...
                        while(rs.next()) {
                            ...
                            cal.setTime(jobDate);
                            String dayOfWeek = new SimpleDateFormat("EEEE").format(jobDate);
                            String month = new SimpleDateFormat("MMM").format(jobDate);
                            int year = cal.get(Calendar.YEAR);
                            String formattedDate = dayOfWeek + " " + day + suffix + " " + month + ", " + year;
                    ...
                    <div class="job-card">
                        ...
                        <div class="status-wrapper">
                            ...
                            <span class="status-badge completed"><%= status %></span>
                        </div>
                    </div>
                    <%
                        }
    ...
    <script src="past-jobs.js"></script>
</body>
</html>