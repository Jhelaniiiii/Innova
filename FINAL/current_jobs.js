document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded for current jobs page');
    ...
    const jobsList = document.getElementById('current_jobsList');
    if (!jobsList) {
        console.error('Current jobs list not found');
        return; // Exit if no jobs list found
    }
    
    const jobs = Array.from(jobsList.querySelectorAll('.current_job-card'));
    console.log('Found ' + jobs.length + ' current job cards');
    ...
    function displayJobs() {
        console.log('Displaying jobs for page', currentPage);
